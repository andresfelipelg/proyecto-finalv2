...
@section('contenido')
    ...
    <form action="{{ route('politicas.update', $politica->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
             ...
             <div class="col-5 pt-5 m-auto ">
              <div class="text-center mt-5 ">
                  ...
                  <h1 class= "mt-3 h2 font-weight-normal text-white" >Editar politicas</h1>

                  <div class="mb-3 mt-3 text-start">
                    <select class="form-select" aria-label="Default select example" name="empresa_id" id="empresa_id">
                       <option value="">seleccione empresa</option>
                       @foreach($empresas as $value)
                       <option value="{{ $value->id }}" {{$value->id==$politica->empresa_id ? 'selected' : ''}}>{{ $value->nom_empresa }}</option>
                       @endforeach
                    </select>
                </div>

                <div class="mb-3 mt-3 text-start">
                    <input class="form-control" type="text" name="nom_empresa"  value="{{ $politica->nom_empresa }}">
                ...
                <div class="mb-3 mt-3 text-start">
                    ...
                    <label for="ruta_compromiso" class="form-label">Documento actual:{{ $politica->ruta_compromiso }}></label>
                ...
                <div class="mb-3 mt-3 text-start">
                    <!--<input class="form-control" type="text" name="ruta_hv" placeholder="subir hoja de vida">-->
                    <label for="ruta_compromiso" class="form-label">Documento actual:{{ $politica->ruta_requisitos }}></label>
                ...
                <div class="mb-3 mt-3 text-start">
                    <!--<input class="form-control" type="text" name="ruta_hv" placeholder="subir hoja de vida">-->
                    <label for="ruta_compromiso" class="form-label">Documento actual:{{ $politica->ruta_objetivos }}></label>
                ...
                <div class="mb-3 mt-3 text-start">
                    <!--<input class="form-control" type="text" name="ruta_hv" placeholder="subir hoja de vida">-->
                    <label for="ruta_compromiso" class="form-label">Documento actual:{{ $politica->ruta_documentacion }}></label>
                ...
                <div class="mb-3 mt-3 text-start">
                  ...
                  <div class="mb-3 mt-3 text-start">
                    <input class="form-control" type="date" name="fecha" value="{{ $politica->fecha}}">
                  </div>
